...
uniform bool is_spotlight; //is spotlight using
// function prototypes
...
{    
    ...
    // == =====================================================
    // Lighting phases: directional light, point lights, and spot light
    // == =====================================================
...
vec3 CalcSpotLight(SpotLight light, vec3 normal, vec3 fragPos, vec3 viewDir)
{
    ...
    // combine results
    vec3 ambient = light.ambient * vec3(texture(tex, TexCoords));
    vec3 diffuse = light.diffuse * diff * vec3(texture(tex, tex));
    vec3 specular = light.specular * spec;
